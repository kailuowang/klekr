...
class Login extends ViewBase {
  ...
  constructor(authUrl) {
    ...
    // Bind methods
    this._showingDetail = this._showingDetail.bind(this);
    this._displayLoginLinks = this._displayLoginLinks.bind(this);
    this._registerEvents = this._registerEvents.bind(this);
    this._toggleMoreAbout = this._toggleMoreAbout.bind(this);
    this._login = this._login.bind(this);
    this._toggleFaq = this._toggleFaq.bind(this);
    this.redirectCountdown = this.redirectCountdown.bind(this);
    this._flashStopLink = this._flashStopLink.bind(this);
    this._displayHelp = this._displayHelp.bind(this);
    this._nextCountdown = this._nextCountdown.bind(this);
    this._stopCountdown = this._stopCountdown.bind(this);
    this._loadAnnouncement = this._loadAnnouncement.bind(this);
