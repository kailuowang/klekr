...
CREATE TABLE "flickr_streams" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" varchar(255), "last_sync" datetime, "created_at" datetime, "updated_at" datetime, "type" varchar(255), "username" varchar(255), "user_url" varchar(255), "collector_id" integer);
...
CREATE TABLE "pictures" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar(255), "url" varchar(255), "created_at" datetime, "updated_at" datetime, "date_upload" datetime, "pic_info_dump" text, "viewed" boolean DEFAULT 'f', "owner_name" varchar(255), "stream_rating" float, "rating" integer DEFAULT 0, "collector_id" integer);
