...
(function() {
  ...
  window.Gallery = (function(superClass) {
    ...
    function Gallery() {
      ...
      this.cacheSize = klekr.Global.defaultGalleryCacheSize || 10;
    ...
    Gallery.prototype.init = function() {
      ...
      this.grid.init(this);
      console.log("Gallery: Initializing with increased cache size to enable navigation");
      return this.increaseCacheSize(2);
    };
    ...
    Gallery.prototype._ensurePictureCache = function() {
      var maxCacheSize, needMoreForCache, picturesAhead;
      if (!this.isLoading()) {
        picturesAhead = this.pictures.length - this._currentProgress();
        maxCacheSize = Math.min(this.cacheSize * this.pageSize(), 50);
